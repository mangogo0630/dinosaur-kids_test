...
export const DINO_TYPES_BY_EGG_INDEX = [
  '燈光怪',
  '黏土怪',
  '音樂怪',
  '筆刷怪',
...
export function resolveDinoTypeByEggIndex(index: number): string {
  return DINO_TYPES_BY_EGG_INDEX[index] ?? DINO_TYPES_BY_EGG_INDEX[0]
}
