...
const dinoHumanLayoutsByEggIndex: readonly DinoHumanLayout[] = [
  ...
  { imageUrl: dinoHumanClayUrl, faceX: 0.665, faceY: 0.3890, faceWidth: 0.2 },
  { imageUrl: dinoHumanMusicUrl, faceX: 0.5378, faceY: 0.4617, faceWidth: 0.1633 },
  { imageUrl: dinoHumanBrushUrl, faceX: 0.535, faceY: 0.4103, faceWidth: 0.1667 },
  { imageUrl: dinoHumanFlashUrl, faceX: 0.4922, faceY: 0.5256, faceWidth: 0.1633, keepOriginalAvatar: true },
]
...
async function generateResultCardImage() {
  ...
  ctx.font = `700 ${nameFontSize}px ChaoGangHei, "Microsoft JhengHei", sans-serif`
  ...
  ctx.font = `500 ${descFontSize}px ChaoGangHei, "Microsoft JhengHei", sans-serif`
